...
_GENERIC_SELF_QUESTIONS = [
    ...
    {"q": "账号目前处于哪个阶段?", "options": ["刚起号 · 摸索期", "卡在某个粉丝量", "想突破瓶颈 / 转型"]},
]
...
2. 已经够具体 → clear=true,questions 给空数组。
3. 不够 → clear=false,出 1-3 个帮他说清**目标 / 痛点 / 阶段**的问题,每题 3-4 个选项,选项贴他这个号的实际情况,供多选。

只输出 JSON:
{{"clear": true/false,
  "questions": [{{"q": "这个号你最想先达成什么?", "options": ["涨粉做大", "提高互动", "提升转化(获客 / 带货)", "立人设 · 定位"]}}]}}"""
