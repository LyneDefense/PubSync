...
样本规模：{stats.get("sample_count", 0)} 条笔记，{stats.get("comment_total", 0)} 条评论。视频样本 {transcript_info.get("video_count", 0)} 条，已解析字幕/口播 {transcript_info.get("transcript_count", 0)} 条。
